              ...
              <table class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="td-actions"><a href="http://localhost:8080/stock/View/stock.php?updatestock=<?php echo $data->getstock_id();?>" class="btn btn-small btn-success"><i class="btn-icon-only icon-edit"> </i></a></td><td class="td-actions">
					<a href="http://localhost:8080/stock/View/stock2.php?deletestock=<?php echo $data->getstock_id();?>" class="btn btn-danger btn-small"><i class="btn-icon-only icon-remove"> </i></a></td>
                  </tr>
